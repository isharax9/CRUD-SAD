...
public class Home extends javax.swing.JFrame {
    ...
    public void loadUsers() {
        ...
        for (User u : userVector) {
            ...
            vector.add(u.getName());
            vector.add(u.getMobile());
            vector.add(u.getEmail());
            vector.add(u.getCountry());
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Sri Lanka", "China", "Sweden", "Australia", "Canada" }));
